...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Adds people at the beginning of the queue instead of the end
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Did not requeue Tim because only a turn value >1 is handled, not <1

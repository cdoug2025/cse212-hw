...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                // For any other location of 'value', need to delete
                // node and reconnect the links to those around the deleted node.
                else
                {
                    curr.Prev!.Next = curr.Next; // Connect Prev node to the Next node
                    curr.Next!.Prev = curr.Prev; // Connect Next node to the Prev node
                }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            // If node contains oldValue, replace with newValue
